        ...
        <div className="navbar  md:px-5 text-black dark:text-white">
            ...
            <div className="navbar-end flex gap-4">
                <label className="cursor-pointer grid place-items-center">
                    <input  onClick={()=>setTheme(!theme)} checked={theme}  type="checkbox" value={theme?'dark':'light'}className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2" />
